...
namespace Medina_Medix_Pharma_Proj
{
    ...
    public partial class Clients : Form
    {
        ...
        private void ChargerDetailsClient()
        {
            if (dgvClients.CurrentRow != null)
            {
                txtNomClient.Text = dgvClients.CurrentRow.Cells[1].Value.ToString();
                txtAdresse.Text = dgvClients.CurrentRow.Cells[2].Value.ToString();
                txtTéléphone.Text = dgvClients.CurrentRow.Cells[3].Value.ToString();
